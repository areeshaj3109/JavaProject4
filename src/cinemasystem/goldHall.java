...
class goldHall1 extends JFrame implements ActionListener{
    private static final int width =600;
    private static final int hieght =600;
    private static final int seatRows = 9;
    ...
    public goldHall1(int id, movie m, customer c) throws FileNotFoundException, IOException{
        this.setLocation((int)getDefaultToolkit().getScreenSize().getWidth()/2 - 300,(int) getDefaultToolkit().getScreenSize().getHeight()/2 - 300);
        ...
        public void actionPerformed(ActionEvent press){
            if(press.getSource()== exitJB)  {
                try {
                    ...
                    Logger.getLogger(goldHall1.class.getName()).log(Level.SEVERE, null, ex);
            ...
            for(int j = tempvalue[0].length - 1; j >= 0; j--) {
                if(tempvalue[i][j]) {
                    ...
                    if(dialogresult == JOptionPane.YES_NO_OPTION) {
                        ...
                        JOptionPane.showMessageDialog(null, "You can not book more than 10 seats");
                    }
                    else {
    ...
    public static void main(String[] args) throws IOException {
        ...
        movie m = null;
        customer c = null;
        goldHall1 h = new goldHall1(id,m,c);
    }
