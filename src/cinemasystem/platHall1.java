...
class platHall1 extends JFrame implements ActionListener{
    ...
    public platHall1(int id, movie m, customer c) throws FileNotFoundException, IOException{
        ...
        public void actionPerformed(ActionEvent press){
            if(press.getSource()== exitJB){
                try {
                    ...
                    Logger.getLogger(platHall1.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String[] args) throws IOException {
        ...
        movie m = null;
        customer c = null;
        platHall1 h = new platHall1(id,m,c);
    }
